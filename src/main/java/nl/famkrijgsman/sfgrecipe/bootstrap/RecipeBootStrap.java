package nl.famkrijgsman.sfgrecipe.bootstrap;

import lombok.extern.slf4j.Slf4j;
import nl.famkrijgsman.sfgrecipe.domain.*;
import nl.famkrijgsman.sfgrecipe.repositories.CategoryRepository;
import nl.famkrijgsman.sfgrecipe.repositories.RecipeRepository;
import nl.famkrijgsman.sfgrecipe.repositories.UnitOfMeasureRepository;
...
public class RecipeBootStrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootStrap(CategoryRepository categoryRepository, RecipeRepository recipes, UnitOfMeasureRepository unitOfMeasureRepository) {
